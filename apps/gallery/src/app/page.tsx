...
export default function Home() {
  ...
  return <div>
    <div>
      ...
      <div className="p-4 md:gap-4 gap-2 mt-40 mb-4">
        <div className="my-4">
        ...
        <div className="flex flex-col md:flex-row w-full items-center gap-12">
          ...
          <Divider orientation="vertical" className="h-[800px]"></Divider>
      ...
      <div className="mt-40 mb-4">
        ...
        <div className="md:flex gap-2 p-4 md:h-[850px] object-contain">
          <div className="md:w-[30%] h-full flex flex-col gap-2">
            <div className="w-full h-[300px] bg-crust rounded-xl justify-evenly md:py-4 md:px-8 p-2 flex flex-col">
            ...
            <div className="w-full h-[calc(100%-300px-1rem)] bg-mantle rounded-xl justify-evenly p-2 md:px-8 md:py-4 flex flex-col">
          ...
          <div className="md:w-[45%] flex flex-col gap-2 h-full">
            ...
            <div className="w-full md:h-[calc(100%-100px-1rem)] rounded-xl">
              <div className="flex gap-2 h-[300px] items-center">
                <div className="w-1/2  flex flex-col justify-center items-center h-[calc(100%-0.5rem)] mb-2 bg-mantle rounded-xl px-8">
                ...
                <div className="w-1/2 bg-crust rounded-tl-xl rounded-tr-xl h-full flex flex-col py-4 px-8 justify-around">
                  <div>
              ...
              <div className="bg-crust rounded-xl rounded-tr-none h-[calc(100%-300px)] p-2">
                <img src="/team-work.jpg" className="w-full h-full rounded-xl" alt="" />
              </div>
            </div>
          </div>
          <div className="w-[25%] flex flex-col h-full gap-2">
