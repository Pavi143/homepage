            ...
            <div className="w-full max-w-full">
                <ul className=" flex gap-2  list-none">
                    {blogItems.map((blogItem, i) => (
                        <li key={i} aria-current={activeItem === i}
                            className="w-[8%] overflow-hidden rounded-2xl first:w-[1%] last:w-[1%] hover:w-[40%] [&[aria-current='true']]:w-[48%] transition-[width] ">
                            <div className="flex flex-col w-full  p-4  gap-2 bg-mantle rounded ">
